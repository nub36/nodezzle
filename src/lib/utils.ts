...
/** Дата-время из ISO-строки сервера «13 сент. 2026, 12:40:01». */
...
/** Длительность из миллисекунд: «1,2 с», «340 мс», «2 мин». */
export function formatDurationRu(ms: number): string {
  ...
  return `${(ms / 60_000).toLocaleString('ru-RU', { maximumFractionDigits: 1 })} мин`;
}
